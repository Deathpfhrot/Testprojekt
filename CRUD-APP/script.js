//globale Variablen sind immer ganz oben deklariert

let names = ['Erica Musermann', 'John Doe'];
...
function deleteContact(i) {
    names.splice(i, 1); //i ist die stelle des arrays gemeint 1 ist die anzahl was gelöscht werden soll
    phoneNumbers.splice(i, 1);

    render(); //zum löschen/aktualisieren der änderungen die übernommen werden sollen
    save();
}
...
function save() {
    ...
    localStorage.setItem('names', namesAsText); // 'names' ist der schlüssel, namesAsText das umgewandelte Value.
